        ...
        <div className='about scetionDiv' id='About'>
                <div className="flex md:justify-center">
                    ...
                    <div className="md:w-1/2 pl-8 p-3 py-12">
                        ...
                        <p className="text-xl mb-6 text-gray-500">My name is Mohamed, I am a 23 years old web developer based in Egypt.</p>
                        <ul>
                            <li className='flex mb-4 '>
                                <strong className='w-[80px]'>Name :</strong> <span className='text-gray-400'>Mohamed Gamal Ragap</span>
                            </li>
                            <li className='flex mb-4 '>
                                <strong className='w-[80px]'>Age :</strong> <span className='text-gray-400'>23 Years Old</span>
                            </li>
                            <li className='flex mb-4 '>
