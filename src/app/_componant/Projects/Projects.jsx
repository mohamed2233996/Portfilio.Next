            ...
            <div className='container m-auto'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-16">
                    {projects.projects.map((item) =>{
                        return(
                            <a href={item.link} style={item.style} className='relative transition ease-in-out delay-300 overflow-hidden w-full h-[300px] bg-cover bg-no-repeat bg-center flex justify-center items-center prog-cont'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16'>
                    {projects.mydone.map((item) =>{
                        return(
                            <div className='shadow-lg rounded-lg flex justify-center items-center flex-col p-2'>
